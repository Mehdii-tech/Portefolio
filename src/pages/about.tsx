...
const About: NextPage = () => {
  return (
        <>
      <div className="text-white fixed top-0 bg-gradient-to-b from-black w-full z-50 xxs:space-x-3">
        <div className="px-10 flex flex-wrap p-5  flex-col xl:flex-row md:flex-row sm:flex-row xs:flex-row xxs:flex-row  items-center">
          <div className="ml-auto flex flex-row space-x-6 xxl:w-10/12 xl:w-11/12 lg:w-10/12 md:w-10/12 sm:w-3/4 xs:w-3/4 xxs:w-9/12  xxl:text-lg xl:text-sm lg:text-sm md:text-sm xs:text-sm xxs:text-xs font-light">
            ...
            <a href="#" onClick={()=>router.push("/")} className="hover:text-gray-400">Projects</a>
          </div>
    ...
    <div className="px-5 h-full flex items-center justify-center">
      <div className="flex flex-col xxl:w-1/2 xl:w-1/3 lg:w-3/4 md:w-3/4 sm:w-3/4 space-y-2 py-12 ">
        ...
        <div className="flex text-white space-x-4 xxl:text-sm xl:text-sm lg:text-sm md:text-sm sm:text-xs xs:text-xs xxs:text-xs font-bold px-2  flex-row w-full ">
          ...
          <a className="space-x-1 animate-bounce" href="#" onClick={()=>router.push('/')}><span className="font-normal">↗</span><span className="tracking-tight">See my Projects</span></a> 
          <a href="#bottom" className="flex space-x-1 cursor-pointer  ">
        ...
        <div className="absolute w-full h-48  "></div>
